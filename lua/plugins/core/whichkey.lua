plugin("which-key")
	...
	:keymaps({
		...
		k:map("n", "<M-S-1>", k:cmd("tabn 1", true), "Go to tab 2"),
		k:map("n", "<M-S-2>", k:cmd("tabn 2", true), "Go to tab 2"),
		k:map("n", "<M-S-3>", k:cmd("tabn 3", true), "Go to tab 3"),
		k:map("n", "<M-S-4>", k:cmd("tabn 4", true), "Go to tab 4"),
		k:map("n", "<M-S-5>", k:cmd("tabn 5", true), "Go to tab 5"),
		k:map("n", "<M-S-6>", k:cmd("tabn 6", true), "Go to tab 6"),
		k:map("n", "<M-S-7>", k:cmd("tabn 7", true), "Go to tab 7"),
		k:map("n", "<M-S-8>", k:cmd("tabn 8", true), "Go to tab 8"),
		k:map("n", "<M-S-9>", k:cmd("tabn 9", true), "Go to tab 9"),
		-- Dev
		k:group("dev", "<leader>="),
