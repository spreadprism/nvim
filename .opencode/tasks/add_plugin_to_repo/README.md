...
This task outlines the process for adding a new plugin to the repository.
...
1. [Receive repo URL and name](1_receive_repo_url_and_name.md)
...
5. [Run nix flake update](5_run_nix_flake_update.md) - **Important: Use `just update plugins`**
